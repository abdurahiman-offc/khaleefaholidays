...
export default function Hero() {
    return (
        <section id="hero" className="relative min-h-screen w-full overflow-hidden flex flex-col items-center pt-24 lg:pt-48 pb-[50px] bg-transparent">
            <div className="container mx-auto px-6 relative z-10 flex-grow flex flex-col justify-center">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16 mb-24">
                    ...
                    >
                        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="flex items-center gap-2 text-[#0047FF] font-black text-xs md:text-sm tracking-[0.2em] uppercase mb-6 relative z-[999]">
                        ...
                        <div className="relative mb-8">
                            ...
                            <div className="lg:hidden relative w-full flex flex-col items-center mb-0">
                                {/* TOP TEXT: Your Journey */}
                                <motion.h1
                                    initial={{ opacity: 0, y: -20 }}
                                    animate={{ opacity: 1, y: 0 }}
                                    transition={{ duration: 0.8, delay: 0.3 }}
                                    className="text-5xl md:text-7xl font-outfit font-black leading-none tracking-tight text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)] z-30 whitespace-nowrap mb-8"
                                >
                                    Your Journey
                                </motion.h1>
                                ...
                                <div className="relative w-full flex items-center justify-center mb-8">
                                    ...
                                    <motion.div
                                        ...
                                        className="relative w-full h-[332px] md:h-[427px] flex items-center justify-center"
                                    >
                                        <div className="relative w-full h-full max-w-[225px] md:max-w-[342px] aspect-[4/2.2] flex items-center justify-center">
                                    ...
                                    {/* FOREGROUND: Aeroplane (Independent) */}
                                    <motion.div
                                    ...
                                    >
                                        <div className="relative w-[700px] md:w-[1000px] max-w-[100vw] aspect-video">
                                            <Image src="/images/aeroplaneimg2.png" alt="Flight" fill className="object-contain drop-shadow-2xl" />
                                        </div>
                                    </motion.div>
                                </div>

                                {/* BOTTOM TEXT: Begins With Us */}
                                <motion.h1
                                    initial={{ opacity: 0, y: 20 }}
                                    animate={{ opacity: 1, y: 0 }}
                                    transition={{ duration: 0.8, delay: 0.5 }}
                                    className="text-5xl md:text-7xl font-outfit font-black leading-none tracking-tight text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)] z-30 flex flex-col items-center"
                                >
                                ...
                                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.6 }} className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto mt-10 mb-0">
